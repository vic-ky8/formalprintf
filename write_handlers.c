#include "main.h"
/**
 * handle_write_char - Afunction that Prints a string
 * @c: the char types
 ...
 * @flags:  use to calculates active flags.
 * @width: to get width.
 * @precision: the precision specifier
 * @size: size specifier.
...
/**
 * write_num - prints a function that Write a number using a bufffer.
...
/**
 * write_unsgnd - prints a function that Writes an unsigned number
